...
const TvIcon = ({ className = 'w-5 h-5' }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4h10M5 8h14c1.1 0 2 .9 2 2v8c0 1.1-.9 2-2 2H5c-1.1 0-2-.9-2-2v-8c0-1.1.9-2 2-2zM9 20l3-3 3 3" />
  </svg>
);
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: '/admin/social',
        icon: TvIcon,
        description: 'Gestão Live Marketing',
      },
      {
        name: 'Parceiros',
        href: '/admin/social/sponsors',
        icon: StarIcon,
        description: 'Logos para Murais',
      },
    ],
  },
  {
