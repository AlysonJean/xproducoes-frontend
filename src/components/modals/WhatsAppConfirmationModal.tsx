// Caminho: frontend/src/components/modals/WhatsAppConfirmationModal.tsx
...
export const WhatsAppConfirmationModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-50 p-4">
      <div className="bg-muted p-8 rounded-lg shadow-2xl w-full max-w-lg border">
        <h2 className="text-2xl font-bold mb-4">Confirmar Envio de Mensagem</h2>
        <p className="text-muted-foreground mb-6">
          A seguinte mensagem será enviada para o número {contactNumber}.
        </p>
        <div className="bg-muted p-4 rounded-md mb-6 whitespace-pre-wrap text-muted-foreground">
          {message}
        </div>
