  ...
  return (
    <PageLayout title="Carreiras" description="Trabalhe conosco - vagas e cultura da empresa">
      <div className="max-w-4xl mx-auto bg-card rounded-xl p-8 border border-border">
        <h1 className="text-2xl font-bold mb-4">Trabalhe na X Produçoes e Eventos</h1>
        ...
        <p className="text-muted-foreground">Envie seu currículo para <strong>suporte@xproducoeseventos.com.br</strong> com o título da vaga no assunto.</p>
