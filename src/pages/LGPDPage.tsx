...
export const LGPDPage: React.FC = () => (
  <PageLayout title="LGPD" description="Informações sobre tratamento de dados">
    <div className="max-w-4xl mx-auto bg-card rounded-xl p-8 border border-border">
      ...
      <p className="text-muted-foreground">Informamos como tratamos dados pessoais, direitos dos titulares e canais de contato para solicitações (ex.: exclusão, acesso). Para exercer seus direitos, envie email para <strong>suporte@xproducoeseeventos.com.br</strong>.</p>
