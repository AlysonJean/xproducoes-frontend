  ...
  return (
    <AdminLayout title="Gestão de Equipamentos" breadcrumbs={[{ name: 'Admin' }, { name: 'Equipamentos' }]}>
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Link to="/admin/equipment/new" className="self-start sm:self-auto">
                ...
                <tr key={item.id} className="hover:bg-muted/30 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex justify-end gap-2">
                      <Link to={`/admin/equipment/${item.id}/edit`} title="Editar equipamento" aria-label="Editar equipamento">
